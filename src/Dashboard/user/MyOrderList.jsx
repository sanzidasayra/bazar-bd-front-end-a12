    ...
    <div className='container mx-auto px-4 py-6'>
      ...
      <div className='overflow-x-auto shadow-lg rounded-lg bg-white'>
        <table className='min-w-full divide-y divide-gray-200 text-sm text-gray-700'>
          <thead className='bg-gradient-to-r from-green-100 to-blue-100 text-gray-800'>
            {" "}
            ...
            order.priceHistory?.length > 0 && (
              <div className='mt-12' key={order._id}>
                <h3 className='text-xl font-semibold mb-4 text-gray-800'>
                  Price Trend for:{" "}
                  <span className='text-blue-600'>{order.productName}</span>{" "}
                  {/* Blue theme for product name */}
                </h3>
