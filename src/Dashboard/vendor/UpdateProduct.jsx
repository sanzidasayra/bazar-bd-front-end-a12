...
const UpdateProduct = () => {
  ...
  return (
    <div className="max-w-xl mx-auto p-10 shadow-2xl rounded-2xl">
      <h2 className="text-3xl font-bold text-center mb-8 text-[#03373D]">Update Product</h2>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        
        {/* Item Name */}
        <div>
          <label htmlFor="itemName" className="block text-sm font-medium text-[#03373D]">Item Name</label>
          <input
            type="text"
        ...
        {/* Price Per Unit */}
        <div>
          <label htmlFor="pricePerUnit" className="block text-sm font-medium text-[#03373D]">Price per Unit</label>
          <input
            type="number"
            step="0.01"
        ...
        {/* Market Name */}
        <div>
          <label htmlFor="marketName" className="block text-sm font-medium text-[#03373D]">Market Name</label>
          <input
            type="text"
        ...
        {/* Market Date */}
        <div>
          <label htmlFor="marketDate" className="block text-sm font-medium text-[#03373D]">Market Date</label>
          <input
            type="date"
        ...
        {/* Product Image URL */}
        <div>
          <label htmlFor="productImage" className="block text-sm font-medium text-[#03373D]">Image URL</label>
          <input
            type="url"
        ...
        {/* Item Description */}
        <div>
          <label htmlFor="itemDescription" className="block text-sm font-medium text-[#03373D]">Item Description</label>
          <textarea
