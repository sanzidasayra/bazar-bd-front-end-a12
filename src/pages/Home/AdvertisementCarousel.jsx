...
const AdvertisementCarousel = () => {
  ...
  useEffect(() => {
    const fetchAds = async () => {
      try {
const response = await fetch("http://localhost:5000/advertisements?status=approved");
  ...
  return (
    <div className="mt-10 px-4">
      <h2 className="text-3xl font-bold text-center mb-6">Advertisement Highlights</h2>
      ...
      >
        {ads.map((ad) => (
          <SwiperSlide key={ad._id} className="bg-gray-200 p-6 rounded-lg shadow-lg">
