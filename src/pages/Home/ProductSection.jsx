...
const ProductSection = () => {
    ...
    <div>
      <div className='text-center mb-10'>
        ...
        <p className='text-base md:text-lg max-w-3xl mx-auto text-gray-700 dark:text-gray-300'>
          Discover today’s best prices for essentials at{" "}
          <strong>BazarBD</strong>.<br />
  ...
  {products.map((product) => {
    const latestPrice = product.prices?.[0]; // first price in array
    return (
      <div
        key={product._id}
      ...
      >
        <span className="absolute top-3 right-3 px-3 py-1 bg-gradient-to-r from-[#EC5800] to-[#FFA500] dark:from-gray-700 dark:to-gray-900 text-black rounded-full font-bold text-xs shadow z-10 dark:text-gray-50">
          NEW
        </span>
        <img
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm text-gray-700 dark:text-gray-300 font-medium">
                {latestPrice?.marketName || "Unknown Market"}
              </span>
            </div>
          </div>
